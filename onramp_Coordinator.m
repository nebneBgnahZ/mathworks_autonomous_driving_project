classdef onramp_Coordinator < matlab.DiscreteEventSystem & ...
    ...
    methods (Access=protected)
        ...
        function [entity, events] = INFOEntry(obj, storage, entity, ~)
            events = [];
            if storage == 1 % input port storage
                entity.data.ID = obj.nums;
                obj.nums = obj.nums + 1;
