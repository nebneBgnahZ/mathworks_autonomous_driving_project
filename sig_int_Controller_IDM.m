classdef sig_int_Controller_IDM < matlab.DiscreteEventSystem & ...
    ...
    properties
        ...
        veh = zeros(1000, 3) % lane, current v, current p
                ...
                case 'iter'
                    ...
                    if entity.data.ID ~= 1001
                        ...
                        [entity.data.Speed, entity.data.Position] ...
                            = sig_int_getStatus_IDM(obj.veh, entity.data.ID, obj.light_cycle, obj.light_phase);
