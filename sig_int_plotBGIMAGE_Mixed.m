function sig_int_plotBGIMAGE_Mixed()
...
LH(3) = plot(nan, nan, 's', 'MarkerSize',7,'MarkerEdgeColor','green',...
    'MarkerFaceColor','green');
LH(4) = plot(nan, nan, 's', 'MarkerSize',7,'MarkerEdgeColor','red',...
    'MarkerFaceColor','red');
LH(5) = plot(nan, nan, 's', 'MarkerSize',7,'MarkerEdgeColor','yellow',...
